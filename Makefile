...
VENDOR_SDK_ZIP_2.2.1 = ESP8266_NONOS_SDK-86acbd8c5ead615b2729013ca4efb8e3fa0828b1.zip
VENDOR_SDK_DIR_2.2.1 = ESP8266_NONOS_SDK-86acbd8c5ead615b2729013ca4efb8e3fa0828b1
...
.sdk_patch_2.1.0:
	echo -e "#undef ESP_SDK_VERSION\n#define ESP_SDK_VERSION 020100" >>$(VENDOR_SDK_DIR)/include/esp_sdk_ver.h
	patch -N -d $(VENDOR_SDK_DIR_2.1.0) -p1 < c_types-c99_sdk_2.patch
	@touch $@
